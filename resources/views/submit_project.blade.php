    ...
    <div class="mx-20 mt-5">
        ...
        <section class="bg-white dark:bg-gray-900 p-0">
          <div class="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
              <h1 class="text-center mb-5">Submit a project</h1>
